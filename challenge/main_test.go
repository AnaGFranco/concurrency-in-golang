...
func Test_main(t *testing.T) {
	// salva stdout existente
	stdOut := os.Stdout

	/* Pipe retorna um par conectado de arquivos; lê de r bytes de retorno gravados em w.
	Ele retorna os arquivos e um erro, se houver. */

	r, w, _ := os.Pipe()

	// substitui stdout,stderr por pipe writer
	os.Stdout = w
